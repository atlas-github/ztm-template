  ...
  <div>
    <div id="header" class="bg-[url('/hero-bg.jpg')] md:px-20 px-5">
      ...
      <div class="grid md:grid-cols-2 pb-20 pt-10">
        ...
        <div>
          <h1
            class="pt-5 text-8xl text-white text-center font-lilita font-bold uppercase"
          >
            Classic Burger
          </h1>
          <h2
    ...
    <div
      id="section-1"
      class="text-center bg-[url('/three-burgers.jpeg')] pb-60 bg-cover bg-center"
    >
      <h1 class="text-6xl uppercase font-oswald text-center pt-20 md:px-24 px-5">
        The burger tastes better when you eat it with family
      </h1>
      <p
        class="font-oswald font-light text-gray-500 text-center text-lg py-6 md:px-28 px-10"
      >
    ...
    <div id="section-3" class="text-center">
      ...
      >
        ...
        <div
          class="md:col-span-7 bg-[url('/burger-bg-1.jpg')] bg-cover bg-center text-right pr-10 pt-10"
        >
          <h4>
            Crispy <br />
            Chicken
      ...
      <div class="md:grid grid-cols-3 md:px-40 mt-5 gap-5">
    ...
    <div id="section-4" class="md:px-20 bg-gray-100 py-20">
      <div class="grid md:grid-cols-2">
        ...
        <h3
          class="uppercase text-center font-oswald text-5xl md:pl-20 md:pr-4 px-10 pt-10 leading-snug"
        >
